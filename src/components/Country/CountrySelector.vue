...
export default {
  ...
  methods: {
    ...
    searchCountry(keyword, event) {
      // 创建正则，如： /^a|\\|a/gi
      const reg = new RegExp(`^${keyword}|\\|${keyword}`, 'gi');
    ...
    handleKeyboardEvent(event) {
      ...
      switch (keyCode) {
        ...
        case 13: // enter键
          ...
          {
            const target = this.$refs.panel.querySelector('.search-item.active');
